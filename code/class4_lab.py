...
#           and all lower case
ufo.rename(columns={'City':'city', 'Colors Reported':'colors', 'Shape Reported':'shapereported', 'State':'state', 'Time':'time'}, inplace=True)
...
ufo[(ufo.year==2014)].groupby('day').city.count().plot(  kind='bar',
                                                        color='b', 
                                                        title='UFO Sightings in 2014')


test=ufo[(ufo.year==2014)].groupby('day')
'''
Part 2: IRIS
